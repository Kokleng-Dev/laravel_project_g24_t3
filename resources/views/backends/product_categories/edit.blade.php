...
@section('content')
   <div class="card">
    <div class="card-header text-primary">
        <h2><i class="fa fa-user"></i> {{__("Edit Product Category")}}</h2>
    </div>
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $product_category->name }}" name="name" required>
                    </div>
                    <div class="mb-3">
                        <label for="note">{{__('Note')}}</label>
                        <input type="text" class="form-control" value="{{ $product_category->note }}" name="note">
                    </div>
                </div>
                <div class="col-12">
