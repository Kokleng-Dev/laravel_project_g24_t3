...
@section('content')
   <div class="card">
    <div class="card-header text-primary">
        <h2><i class="fa fa-user"></i> {{__("Edit Banner")}}</h2>
    </div>
    <div class="card-body">
        <a href="{{route('admin.banner')}}" class="btn btn-sm btn-danger"><i class="fa fa-reply"></i> {{__('Back')}}</a>
        <form action="{{ route('admin.bulk.update', $banner->id) }}" class="my-2" method="POST"  enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $banner->note }}"  name="note">
                    </div>
                    <div class="mb-3">
